...
sites_in_reserve_buff <- st_intersection(dive_sites_sf, reserve_buff_boundary) #160 unique sites
...
missing_ids <- setdiff(dive_sites$site_id, ids) #2,090 outside 
...
missing_ids <- setdiff(dive_sites$site_id, ids) #1,793 outside 
